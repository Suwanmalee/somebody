...
const DUMMY_HAMSTERS = [
  {
    ...
    img: 'https://blog.omlet.us/wp-content/uploads/sites/6/2023/08/Hamster-laying-down-on-the-counter-scaled.jpg',
  },
  {
    id: 2,
    name: 'Squeaky',
    ...
    return (
      ...
      >
        <div className="relative w-full h-full bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div
            className={`absolute top-10 left-10 text-4xl font-bold text-blue-800 border-4 text-blue-800 px-4 py-2 rounded-lg transform -rotate-20 ${
  ...
  return (
    <div className="font-inter flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-orange-200 via-amber-100 to-yellow-200 p-4 overflow-hidden">
      ...
      <div className="flex items-center text-gray-700 mb-4">
        <HeartHandshake className="w-8 h-8 mr-2 text-blue-800" /> {/* ใช้ Lucide PawPrint */}
        <h1 className="text-3xl font-bold tracking-tighter">Animal Crossing</h1>
      </div>
